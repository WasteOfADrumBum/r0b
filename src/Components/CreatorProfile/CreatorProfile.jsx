        ...
        <Col md={8} className="text-left pt-4">
          <Row>
            ...
            <Col md={2} className="m-auto">
              ...
              <a href="tel:8283338983"><FaMobileAlt style={{ fontSize: "2rem", color: "black" }}/></a>
            </Col>
          </Row>
          ...
          <p>
            ...
            Dedicated to the construction and optimizing the performance designs
            for high impact websites. Recently earned a certificate in Full
            Stack Web Development from The University of North Carolina at
            Chapel Hill. Newly equipped with a diverse and promising set of
